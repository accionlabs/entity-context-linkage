...
**License ID:** TL-542FBF0F  
**Tower Site ID:** CC-TWR-996840  
**MLA Reference:** MLA-VERI-2016

---

**THIS TOWER SITE LICENSE AGREEMENT** ("License Agreement") is entered into as of 05/04/2007 ("Commencement Date"), by and between:
...
**1.1 Tower Space.** Licensor grants up to **4 antenna(s)** at **80 ft** RAD center, and **1 RRU(s)**.

**1.2 Equipment Manifest:**

| Item | Qty | Model | Location |
|------|-----|-------|----------|
| Panel Antenna | 4 | Samsung MT6407 | 80ft, 1 sector(s) |
| RRU | 1 | Nokia AirScale AAHF B2/B4/B66 | 80ft |
...
**2.1 Term.** 20 years, from 05/04/2007 to 29 April 2027.
...
**3.1 Monthly Rent.** **$2,562.97/month** ($30,755.64/year).

**3.2 Escalation.** 2.6% annually.

**3.3 Breakdown:**
- Antenna space: $1,409.63/mo
- Ground space: $640.74/mo
- Power/utilities: $512.59/mo
...
---
*Exhibits: Site Plan (CC-TWR-996840), Equipment Layout, MLA (MLA-VERI-2016)*