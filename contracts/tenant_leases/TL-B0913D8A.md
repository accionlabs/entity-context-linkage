...
**Sublicense ID:** TL-B0913D8A  
**Tower Site ID:** CC-TWR-713762  
**MLA Reference:** MLA-T-MO-2017

---

**THIS TOWER SITE SUBLICENSE AGREEMENT** ("Sublicense Agreement") is entered into as of Dec. 26, 2005 ("Commencement Date"), by and between:
...
WHEREAS, Licensor operates tower **CC-TWR-713762** in Kenosha, WI;
...
**1.1 Tower Space.** Space for up to **8 antenna(s)** at **182 ft** RAD center, and **2 RRU(s)**.

**1.2 Equipment Manifest:**

| Item | Qty | Model | Location |
|------|-----|-------|----------|
| Panel Antenna | 8 | CommScope SBNHH-1D65C | 182ft, 2 sector(s) |
| RRU | 2 | Nokia AirScale AAHF B41/B71 | 182ft |
...
**2.1 Term.** 20 years, from Dec. 26, 2005 to Dec. 21, 2025.
...
**3.1 Site Fee.** **$4,347.84/month** ($52,174.08/year).

**3.2 Escalation.** 1.7% annually.

**3.3 Breakdown:**
- Antenna space: $2,391.31/mo
- Ground space: $1,086.96/mo
- Power/utilities: $869.57/mo
...
---
*Exhibits: Site Plan (CC-TWR-713762), Equipment Layout, MLA (MLA-T-MO-2017)*