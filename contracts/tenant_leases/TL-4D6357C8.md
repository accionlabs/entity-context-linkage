...
**License ID:** TL-4D6357C8  
**Tower Site ID:** CC-TWR-698384  
**MLA Reference:** MLA-T-MO-2019

---

**THIS TOWER SITE LICENSE AGREEMENT** ("License Agreement") is entered into as of October 13, 2024 ("Effective Date"), by and between:
...
**1.1 Tower Space.** Space for up to **7 antenna(s)** at **140 ft** RAD center, and **2 RRU(s)**.

**1.2 Equipment Manifest:**

| Item | Qty | Model | Location |
|------|-----|-------|----------|
| Panel Antenna | 7 | Nokia AAFIA | 140ft, 2 sector(s) |
| RRU | 2 | Nokia AirScale AAHF B41/B71 | 140ft |
...
**2.1 Term.** 5 years, from October 13, 2024 to 12 October 2029.
...
**3.1 License Fee.** **$2,073.89/month** ($24,886.68/year).
...
---
*Exhibits: Site Plan (CC-TWR-698384), Equipment Layout, MLA (MLA-T-MO-2019)*