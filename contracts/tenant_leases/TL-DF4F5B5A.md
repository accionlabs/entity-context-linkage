...
**Lease ID:** TL-DF4F5B5A  
**Tower Site ID:** CC-TWR-791567  
**MLA Reference:** MLA-T-MO-2020

---

**THIS TOWER SITE LEASE AGREEMENT** ("Lease Agreement") is entered into as of October 24, 2007 ("Start Date"), by and between:
...
**1.1 Tower Space.** Licensee receives up to **7 antenna(s)** at **63 ft** RAD center, and **2 RRU(s)**.

**1.2 Equipment Manifest:**

| Item | Qty | Model | Location |
|------|-----|-------|----------|
| Panel Antenna | 7 | CommScope SBNHH-1D65C | 63ft, 2 sector(s) |
...
**2.1 Term.** 10 years, from October 24, 2007 to October 21, 2017.
...
**3.1 Site Fee.** **$3,368.88/month** ($40,426.56/year).

**3.2 Escalation.** 2.6% annually.

**3.3 Breakdown:**
- Antenna space: $1,852.88/mo
- Ground space: $842.22/mo
- Power/utilities: $673.78/mo
...
---
*Exhibits: Site Plan (CC-TWR-791567), Equipment Layout, MLA (MLA-T-MO-2020)*