...
**Lease ID:** TL-786F1E58  
**Tower Site ID:** CC-TWR-130353  
**MLA Reference:** MLA-VERI-2019

---

**THIS TOWER SITE LEASE AGREEMENT** ("Lease Agreement") is entered into as of 08/05/2021 ("Effective Date"), by and between:
...
**1.1 Tower Space.** Licensee receives up to **4 antenna(s)** at **54 ft** RAD center, and **1 RRU(s)**.

**1.2 Equipment Manifest:**

| Item | Qty | Model | Location |
|------|-----|-------|----------|
| Panel Antenna | 4 | Ericsson AIR 3246 | 54ft, 1 sector(s) |
| RRU | 1 | Nokia AirScale AAHF B2/B4/B66 | 54ft |
...
**2.1 Term.** 20 years, from 08/05/2021 to 07/31/2041.
...
**3.1 Monthly Fee.** **$3,579.89/month** ($42,958.68/year).
...
---
*Exhibits: Site Plan (CC-TWR-130353), Equipment Layout, MLA (MLA-VERI-2019)*