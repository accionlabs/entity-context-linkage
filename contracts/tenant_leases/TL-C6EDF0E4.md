...
**Lease ID:** TL-C6EDF0E4  
**Tower Site ID:** CC-TWR-271276  
**MLA Reference:** MLA-VERI-2021

---

**THIS TOWER SITE LEASE AGREEMENT** ("Lease Agreement") is entered into as of November 22, 2021 ("Commencement Date"), by and between:
...
**1.1 Tower Space.** Licensor grants up to **3 antenna(s)** at **85 ft** RAD center, and **1 RRU(s)**.
...
|------|-----|-------|----------|
| Panel Antenna | 3 | Ericsson AIR 3246 | 85ft, 1 sector(s) |
| RRU | 1 | Nokia AirScale AAHF B2/B4/B66 | 85ft |
...
**2.1 Term.** 5 years, from November 22, 2021 to 11/21/2026.
...
**3.1 License Fee.** **$3,489.04/month** ($41,868.48/year).

**3.2 Escalation.** 2.1% annually.

**3.3 Breakdown:**
- Antenna space: $1,918.97/mo
- Ground space: $872.26/mo
- Power/utilities: $697.81/mo
...
---
*Exhibits: Site Plan (CC-TWR-271276), Equipment Layout, MLA (MLA-VERI-2021)*