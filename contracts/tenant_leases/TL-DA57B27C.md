...
**License ID:** TL-DA57B27C  
**Tower Site ID:** CC-TWR-672547  
**MLA Reference:** MLA-VERI-2018

---

**THIS TOWER SITE LICENSE AGREEMENT** ("License Agreement") is entered into as of 08 May 2015 ("Commencement Date"), by and between:
...
**1.1 Tower Space.** Licensor grants up to **3 antenna(s)** at **146 ft** RAD center, and **1 RRU(s)**.

**1.2 Equipment:**
- 3x Ericsson AIR 3246 at 146 ft
...
**2.1 Term.** 5 years, from 08 May 2015 to May. 06, 2020.
...
**3.1 License Fee.** **$3,762.80/month** ($45,153.60/year).
...
---
*Exhibits: Site Plan (CC-TWR-672547), Equipment Layout, MLA (MLA-VERI-2018)*